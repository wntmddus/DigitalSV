    ...
    return (
        <>
            <div className="wrapper">
                <LandingPageHeader title={'Introduction'} />
                            ...
                            <Row>
                                <Col md="6">
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(" + require("assets/img/sv1.png") + ")"
                                        }}
                                    >
                                        <p className="blockquote blockquote-info">
                                            "We strive to have the best quality product with care" <br></br>
                                            <br></br>
                                        </p>
                                    </div>
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(" + require("assets/img/construction.png") + ")"
                                        }}
                                    ></div>
                                </Col>
                                <Col md="5">
                                    <div
                                        ...
                                        style={{
                                            backgroundImage:
                                                "url(" + require("assets/img/data_table.png") + ")"
                                        }}
                                    ></div>
                                    <h3>
